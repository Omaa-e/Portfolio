...
const Hero = ({ darkmode, toggleDarkmode }) => {
  return (
    <div className='w-full flex flex-col items-center justify-center text-center min-h-screen px-4 '>
      <div className='w-full flex flex-col lg:flex-row items-center justify-center gap-10 '>
        <div className='md:w-auto'>
          ...
          <div className='mx-auto text-center lg:text-left'>
            <button className='py-2 px-4 text-sm bg-[#7B466A] text-white rounded-full mx-auto mb-8'>Hello!</button>
            ...
            <p className='text-xl mt-5 mb-10'>Frontend Developer <span>|</span> Problem Solver</p>
